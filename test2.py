...
print('fini')
OME, AMPL = compute_response_curve(T, Vdc, Vac, omega0, M, C, K, 0.97, 1, 0.00001, 60, 5000, OMEGA_bal, tolerance=0.00001)
print('fini')
OME2, AMPL2 = compute_response_curve(T, Vdc, Vac, omega0, M, C, K, 1, 0.97, -0.00001, 60, 5000, OMEGA_bal, tolerance=0.00001)
print('fini')
t_init = tt[-1]
Y0 = Yt[-1]
dY0 = dYt[-1]
...
print('fini')
OME3, AMPL3 = compute_response_curve(T, Vdc, Vac, omega0, M, C, K, 0.97, 1, 0.00001, 60, 5000, OMEGA_bal, tolerance=0.00001)
print('fini')
OME4, AMPL4 = compute_response_curve(T, Vdc, Vac, omega0, M, C, K, 1, 0.97, -0.00001, 60, 5000, OMEGA_bal, tolerance=0.00001)
print('fini')
...
plot_response_curve(OME3, AMPL3, OME4, AMPL4, 0, 0, ax, deltam=1e-13, tracer_data=False)
